...
To see if the Town will vote to amend Title V, Article 16 of the Town Bylaws (the tree preservation bylaw) to extend existing protections for trees 6 inches DBH and larger in the setback areas to include trees 10 inches DBH and larger on the rest of the lot beyond the setback. It will modify the definition of protected tree, the protections for trees not removed, and the replacement requirements for trees removed; or take any action related thereto.
